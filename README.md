...
This will build the app for production and deploy it on GitHub pages. Make sure to change the homepage field in package.json with your github.io path. More details here [deployment](https://facebook.github.io/create-react-app/docs/deployment)
